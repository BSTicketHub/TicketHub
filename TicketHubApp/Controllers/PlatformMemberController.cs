...
namespace TicketHubApp.Controllers
{
    public class PlatformMemberController : Controller
    {
        ...
        private IRepository<TicketHubUser> _userRepository;
        private IRepository<TicketHubUser> Repository
        {
            get
            {
                if (_context == null)
                ...
                {
                    _userRepository = new GenericRepository<TicketHubUser>(_context);
                }
