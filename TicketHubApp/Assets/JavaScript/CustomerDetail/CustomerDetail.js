let sidebarItems = Array.from(document.querySelectorAll('.sidebar-nav > div'));
...
function createMemberDetail(){
    ...
    phonePhrase.innerText = "電話 : 0912-564-891";
    ...
    emailPhrase.innerText = "電子郵件 : 123456@gmial.com";
    ...
    memberDetail.append(accountDiv, passwordDiv, nameDiv, genderDiv, phoneDiv, emailDiv, birthdayDiv);
...
function editMemberDetail(){
    ...
    genderInput.options.add(new Option("男", "1"));
    genderInput.options.add(new Option("女", "2"));
    ...
    infoArea.append(nameDiv, genderDiv, phoneDiv, emailDiv, birthdayDiv);
}
